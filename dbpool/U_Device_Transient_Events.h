#ifndef U_DEVICE_TRANSIENT_EVENTS_H
#define U_DEVICE_TRANSIENT_EVENTS_H

#include <QObject>

class U_Device_Transient_Events : public QObject
{
    Q_OBJECT
...
public:
    explicit U_Device_Transient_Events(QObject *parent = 0);
...
#endif // U_DEVICE_TRANSIENT_EVENTS_H
